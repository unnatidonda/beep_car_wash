...
class PopUpReferralCodeScreen extends StatefulWidget {
  const PopUpReferralCodeScreen({super.key});

  @override
  State<PopUpReferralCodeScreen> createState() => _PopUpReferralCodeScreenState();
}

class _PopUpReferralCodeScreenState extends State<PopUpReferralCodeScreen> {
